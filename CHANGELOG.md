...
- 🚨 更精准的诈骗检测：新增投资骗局、杀猪盘等识别模式
- ⚠️ 平台适配：针对小红书、公众号、知乎等平台优化规则
- ✅ 优质内容鼓励：好文章也会收到正面反馈
- 浏览器扩展支持暗色模式，夜间阅读不刺眼
- 扩展新增"静默模式"，安全页面不弹窗打扰
- 自定义关键词：可以添加自己关心的检测词
- API Playground 页面：在浏览器中直接体验评分
- SDK 批量评分示例和 Webhook 回调示例
- 内容质量检测演示页：纯浏览器运行，无需服务器
- Chrome Web Store 上架准备完成
